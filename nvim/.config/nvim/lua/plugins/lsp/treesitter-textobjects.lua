return {
	...
	keys = {
		...
		},
		{
			"]B",
			function()
				require("nvim-treesitter-textobjects.move").goto_next_end("@code_cell.inner", "textobjects")
			end,
			mode = { "n", "x", "o" },
		...
		},
		{
			"[B",
			function()
				require("nvim-treesitter-textobjects.move").goto_previous_end("@code_cell.inner", "textobjects")
			end,
			mode = { "n", "x", "o" },
